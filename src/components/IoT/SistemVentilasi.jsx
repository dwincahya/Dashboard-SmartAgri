...
const SistemVentilasi = () => {
  const [mode, setMode] = useState("manual"); // manual, smart
  const [isVentOn, setIsVentOn] = useState(false);
    ...
    <div className="bg-white p-6 rounded-lg">
      ...
      <div className="mb-4">
        ...
        >
          ...
          <option value="smart">Terjadwal</option>
        </select>
      </div>
      ...
      {mode === "scheduled" && (
        <div className="mb-4">
          <label className="block mb-2 text-gray-600">Waktu Ventilasi</label>
          <input
            type="time"
            className="w-full p-2 border rounded-lg"
            value={scheduleTime}
...
export default SistemVentilasi;
