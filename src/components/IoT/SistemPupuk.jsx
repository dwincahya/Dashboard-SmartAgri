...
const SistemPupuk = () => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      {mode === "manual" && (
        <div className="mb-4">          
          <label class="inline-flex items-center cursor-pointer">
            ...
            <span class="ms-3 text-sm font-medium dark:text-gray-300">Kontrol Pupuk</span>
          </label>
      ...
      {mode === "scheduled" && (
        <div className="mb-4">
          <label className="block mb-2 text-gray-600">Waktu Pupuk</label>
          <input
            type="time"
            className="w-full p-2 border rounded-lg"
            value={scheduleTime}
